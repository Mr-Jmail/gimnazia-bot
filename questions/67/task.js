async function lol(){
    ...
    var photo = "photo-205320016_457239122"
    var hard = 5
    var right_answer = 23
    var explanetion = `В данном случае функция f возвращает значение 23, которое затем записывается в переменную x. Затем значение переменной x выводится на экран. Разумеется на экране увидим число 23.`
