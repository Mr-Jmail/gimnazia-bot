async function lol(){
    ...
    var hard = 3
    var right_answer = 5
    var explanetion = `Встроенная функция range() используется для построения числовых последовательностей. В примере используем команду for и функцию range для выполнения ровно 5 итераций с выводом звездочки. Поэтому выведется 5 звездочек`
