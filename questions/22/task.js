...
async function lol(){
    var question = "Формальные параметры функции f это ..."
    var photo = "photo-205320016_457239073"
    var hard = 5
    var right_answer = "x, y"
    var explanetion = `Формальные параметры функции - это параметры функции, указанные при ее описании (в заголовке функции). В данном случае это x, y.

    Описание функции - это всегда формальность`
