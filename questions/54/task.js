async function lol(){
    ...
    var hard = 7
    var right_answer = 6
    var explanetion = `В этой программе в функцию f передается значение 5, следовательно параметр функции x примет значение 5. Функция печатает x+1, то есть на экране увидим 6.`
