...
async function lol(){
    var question = "Фактические параметры функции f это ..."
    var photo = "photo-205320016_457239101"
    var hard = 5
    var right_answer = "3, 4"
    var explanetion = `Фактические параметры функции - это конкретные значение параметров, переданные в функцию при ее вызове (строка #5). 

    Эти параметры "по факту" передали в функцию, поэтому они "фактические"`
