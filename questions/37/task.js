...
async function lol() {
    var question = "Программа должна вывести числа от 1 до 10 в обратном порядке: 10 9 ... 2 1. Какое число необходимо вписать в красное окошко?"
    var photo = "photo-205320016_457239132"
    var hard = 4
    var right_answer = 0
    var explanetion = `Здесь подходит условие 0 так как мы начинаем отсчет с числа 10 и уменьшаем значения пока i>0.`
            ...
            if(err) {
                ...
                conn.query(amount, (err, res) => {
                    if(err) {
                        ...
                        context.send({ message: `Сейчас у тебя ${res[0].Points}🌟\nПродолжаем проходить квест?`, attachment: "photo-205320016_457239131", keyboard: continuetion})
                    }
                })
            }
        })
