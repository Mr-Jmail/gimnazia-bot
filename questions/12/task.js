async function lol(){
    ...
    var hard = 8
    var right_answer = 15
    var explanetion = `Выражение со скобками вычисляется начиная изнутри. Сначала вызовется внутренняя функция g(7) и вернет значение 14. Затем вызовется внешняя функция f(14) и вернет значение 15.`
