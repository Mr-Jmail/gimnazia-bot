async function lol(){
    ...
    var photo = "photo-205320016_457239094"
    var hard = 5
    var right_answer = 20
    var explanetion = `При вызове функции явно указаны значения всех необязательных параметров, поэтому значения по умолчанию не будут использованы. Функция вернет 20.`
