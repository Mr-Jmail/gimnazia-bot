...
async function lol(){
    ...
    var explanetion = `Записано имя функции prnt, но после этого не стоят круглые скобки.  Поэтому функция print не вызывается и программа ничего не выведет на экран.`
