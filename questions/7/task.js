async function lol(){
    var question = "Определение функции состоит из заголовка и тела. На какой строке записан заголовок функции func?"
    var photo = "photo-205320016_457239055"
    var hard = 5
    var right_answer = 1
    var explanetion = `Заголовок функции это обычно одна строка, содержащая имя функции. В данном случае это строчка 1`
