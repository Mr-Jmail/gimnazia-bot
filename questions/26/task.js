async function lol(){
    ...
    var photo = "photo-205320016_457239078"
    var hard = 5
    var right_answer = "3 3"
    var explanetion = `После выполнения инструкции x = y получим:
    x == 3, y == 3
    
    После выполнения инструкции y = x получим опять же:
    x == 3, y == 3.
    
    На экране увидим 3 3.`
