...
async function lol(){
    var question = "Что означает оператор % в Python?"
    var photo = "photo-205320016_457239097"
    var hard = 2
    var right_answer = "остаток от деления"
    var explanetion = `Оператор % означает остаток от деления.
