...
async function lol(){
    var question = 'Программа должна определять подростка ("Teenager") по его возрасту ("age"). Что следует вписать в синее окошко?'
    var photo = "photo-205320016_457239085"
    var hard = 4
    var right_answer = "and"
    var explanetion = `Предполагается, что подросток должен быть старше 11 лет и младше 18. Для того чтобы записать логическое "И" в Python можно использовать оператор &.
