async function lol(){
    ...
    var photo = "photo-205320016_457239120"
    var hard = 8
    var right_answer = 3
    var explanetion = `Программа в цикле перебирает все элементы массива и подсчитывает количество элементов, которые больше 2. Таких элементов всего 3.`
