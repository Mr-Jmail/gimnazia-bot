async function lol(){
    ...
    var explanetion = `В описании функции prin для параметра n задано значение "по умолчанию". Если при вызове функции конкретное значение параметра будет опущено, но параметр принимает значение "по умолчанию", то есть 2.\n\nТаким образом, вызов prin() приведет к печати на экран цифры 2. А все 4 вызова напечатают число 2021. `
