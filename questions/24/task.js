async function lol(){
    var question = "Нужно объявить 2 целочисленные переменные: x и y. Какой разделитель нужно вписать в красное окошко?"
    var photo = "photo-205320016_457239075"
    var hard = 5
    var right_answer = ","
    var explanetion = `В Python декларироваение нескольких переменных сразу, разделяется запятой`
