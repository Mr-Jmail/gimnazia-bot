async function lol(){
    var question = "Программа должна вызывать функцию hello. Что нужно вписать в синее окошко?"
    var photo = "photo-205320016_457239119"
    var hard = 5
    var right_answer = "hello()"
    var explanetion = `Для вызова функции необходимо записать название функции и добавить круглые скобки. Круглые скобки - это и есть операция вызова функции.
