async function lol(){
    ...
    var photo = "photo-205320016_457239113"
    var hard = 4
    var right_answer = 32
    var explanetion = `Цикл выполняет 5 итераций (i=1,2,3,4,5). На каждой итерации значение y умножается на 2. Таким образом программа выведет на экран 2 в пятой степени, то есть 32.`
