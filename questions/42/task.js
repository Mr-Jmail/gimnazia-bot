...
async function lol(){
    var question = "Мы знаем, что определение функции состоит из заголовка и тела функции. Как называется часть функции, записанная в строчках 2-4?"
    var photo = "photo-205320016_457239096"
    var hard = 5
    var right_answer = "тело"
    var explanetion = `Тело функции - это составной оператор, содержащий действия, выполняемые функцией. Переменные, объявленные в теле функции являются локальными.`
